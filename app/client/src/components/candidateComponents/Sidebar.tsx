import { FileText, Briefcase, Star, Send, MessageSquare, Settings, Home, FileStack } from 'lucide-react';
...
export default function Sidebar({ activePage, onNavigate }: SidebarProps) {
  const menuItems = [
    ...
    { id: 'create-cv', label: 'Create CV', icon: FileText },
  ...
  return (
    <aside className="w-64 h-screen bg-card border-r border-sidebar-border flex flex-col fixed left-0 top-0 z-20">
